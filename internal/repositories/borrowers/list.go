...
func (r *repo) List(ctx context.Context, m *meta.Params) ([]presentations.Borrower, error) {
	var (
	...
	query := `SELECT * FROM borrowers ORDER BY created_at DESC OFFSET :offset LIMIT :limit`
